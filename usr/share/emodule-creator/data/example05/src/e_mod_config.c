...
void
e_int_config_skeletor_module(E_Container *con, Config_Item *ci)
{
    E_Config_Dialog *cfd;
    E_Config_Dialog_View *v;
    char buf[PATH_MAX];

    if(e_config_dialog_find("E", "utils/skeletor")) return;
    ...
    cfd = e_config_dialog_new(con, "Skeletor Settings", "E", "utils/skeletor",
