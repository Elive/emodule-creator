...
e_int_config_HOHO_module(E_Container *con, const char *params) 
{
   ...
   if (e_config_dialog_find("HOHO", "advanced/HOHO")) return NULL;
   ...
   cfd = e_config_dialog_new(con, D_("HOHO Module"), "HOHO", 
                             "advanced/HOHO", buf, 0, v, NULL);
...
_fill_data(E_Config_Dialog_Data *cfdata) 
{
   ...
   cfdata->switch1 = HOHO_conf->switch1;
}
...
{
   HOHO_conf->switch1 = cfdata->switch1;
   e_config_save_queue();
   return 1;
}
